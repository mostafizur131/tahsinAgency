...
const Featured = async () => {
  ...
  return (
    <section>
      ...
      <div className="py-20 bg-primaryLight radius-for-skewed">
        <div className="container px-4 mx-auto">
          <div className="mb-16 flex flex-wrap justify-center md:justify-between items-center">
            <div className="text-center lg:text-left lg:w-1/2">
              <span className="text-primary font-bold text-xl uppercase mb-6 inline-block">
                Featured Projects
              </span>
            ...
            <Link
              className="hidden md:inline-block py-2 px-6 rounded-xl bg-primary text-white font-bold leading-loose transition duration-200"
              href="/projects"
            >
              View More Projects
            </Link>
