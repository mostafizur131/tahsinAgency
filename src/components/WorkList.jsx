          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap -mx-4">
              <div className="mb-12 lg:mb-0 w-full md:w-1/2 lg:w-1/3 px-4">
                ...
                <h4 className="mb-4 text-2xl font-bold font-heading text-black">
                  {data[0]["title"]}
                </h4>
                <p className="text-black leading-loose">{data[0]["des"]}</p>
                <div className="flex items-center text-black mt-10  ">
                  <button className="text-lg text-black mr-2">
                    Learn More
                  </button>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    <path
                      d="M10 1.16666L17 8.16666L10 15.1667M1 8.16666H17H1Z"
                      stroke="black"
                      stroke-width="2"
              ...
              <div className="mb-12 lg:mb-0 w-full md:w-1/2 lg:w-1/3 px-4">
                ...
                <p className="text-black leading-loose">{data[1]["des"]}</p>
                <div className="flex items-center text-black mt-10  ">
                  <button className="text-lg text-black mr-2">
                    Learn More
                  </button>
              ...
              <div className="mb-12 lg:mb-0 w-full md:w-1/2 lg:w-1/3 px-4">
                ...
                <p className="text-black leading-loose">{data[2]["des"]}</p>
                <div className="flex items-center text-black mt-10  ">
                  <button className="text-lg text-black mr-2">
                    Learn More
                  </button>
