      ...
      <section>
        <div className="py-20 bg-black radius-for-skewed">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center lg:items-start justify-between">
              <div className="w-full lg:w-2/4 mb-16 lg:mb-0">
                <a
                  className="inline-block mb-3 text-3xl font-bold leading-none text-white uppercase"
                  href="#"
                >
                  Web Logo
                </a>
                <p className="mb-5 max-w-sm text-white text-xl leading-base ">
              ...
              <div className="w-full lg:w-1/4 mb-16 md:mb-0">
              ...
              <div className="w-full lg:w-1/4 mb-16 md:mb-0">
                <h3 className="mb-6 text-2xl font-bold text-white">Address</h3>
                <p className="text-white text-xl">
                  Design Agency Head Office. <br /> Airport Road
                  <br /> United Arab Emirate
                </p>
              </div>
            </div>
            <p className="text-xl text-white text-center lg:text-left pt-12 mt-16">
              Copyright Tahsin Agency 2023
            </p>
          </div>
        </div>
      </section>
